...
from backend.settings.services import _l
...
# LOCAL ENV
SECRET_KEY = _l('SECRET_KEY')
DEBUG = True if _l('DEBUG') == 'True' else False
ALLOWED_HOSTS = ['*']
...
if DEBUG:
    ...
    # MEDIA_ROOT = '/home/u/uicode/prozdorovie23.ru/public_html/media'
