export default {
    ...
    data() {
        return {
            ...
            isDrop: true,
            isSelected: false,
            defaultValue: 'Выберите специалиста',
            id_item: '',
            counter: false,
            items: [
                {
                    doctor: 'Иванова Александра Васильевна'
                },
                {
                    doctor: 'Петров Валерий Иванович'
                },
            ]
        }
    },
    methods: {
        ...
        select_reset() {
            ...
            let currentSelect = document.querySelectorAll('#isValueDoctor');
            ...
            let buttons = document.querySelectorAll('.select_doctor')
        ...
        setValue() {
            ...
            const handleClick = event => {
                ...
                let buttons = document.querySelectorAll('#isValueDoctor')
                console.log(selected)
                for (let i = 0; i < buttons.length; i++) {
                    document.querySelectorAll('#isValueDoctor')[i].textContent = selected;
                }
            }
            let currentSelect = document.querySelectorAll('#isValueDoctor');
            for (let i = 0; i < currentSelect.length; i++) {
            ...
            this.hideSelect();
            let selector = document.querySelectorAll('.start_specialty_doctor')
